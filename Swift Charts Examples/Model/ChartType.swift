...
enum ChartType: String, Identifiable, CaseIterable {
    ...
    var category: ChartCategory {
        ...
        case .scatter, .vectorField:
            return .point
        case .scrollingBar, .oneDimensionalBar, .screenTime:
            return .bar
        }
    }

    var view: some View {
        overviewOrDetailView(isOverview: true, data1: [0.0])
    }
    ...
    var chartDescriptor: AXChartDescriptor? {
        ...
        case .heartBeat:
            return HeartBeat(isOverview: true, data1: [0.0], title:"Neurokit2 ECG Simulated Data").makeChartDescriptor()
        case .animatingLine:
    ...
    var detailView: some View {
        overviewOrDetailView(isOverview: false, data1: [0.0])
    }

    @ViewBuilder
    private func overviewOrDetailView(isOverview: Bool, data1: [Double]?) -> some View {
        switch self {
        case .oneDimensionalBar:
        ...
        case .heartBeat:
            HeartBeat(isOverview: isOverview, data1: data1, title:"Neurokit2 ECG Simulated Data")
        case .animatingLine:
